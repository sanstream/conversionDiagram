/*
 ...
 Internal (StudyPortals) notes on how to use d3.v2.js
 ---------------------------------------
 d3 is purely for data-visualsation. If you'd like to use it for something else, do not!
 include d3 only where needed and never if you think you might need it.

 to view background information and other resources visit: d3js.org
